						...
						<li><a href="categories.php">Catégories</a></li>
						 <li class="dropdown">
						    ...
						    <div class="dropdown-content">
						      <a href="domaine/informatique.php">Informatique</a>
						      <a href="domaine/mathematique.php">Mathématique</a>
						      <a href="domaine/chimie.php">Chimie</a>
						      <a href="domaine/physique.php">Physique</a>
						    </div>
						  </li>
