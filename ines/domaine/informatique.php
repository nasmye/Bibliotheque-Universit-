...
<head>
	...
	<title>Informatique -Bibliothèque Ines</title>
</head>
<body>
<header>
	<div class="wrraper">
        ...
        <thead>
                  ...
                  <tbody>
                      <?php
                        ...
                        $sql="SELECT cote ,titre ,auteur,type ,quantite ,disponibilite ,date_edition FROM document WHERE domaine LIKE '%$domaine%' ORDER BY date_edition DESC";
